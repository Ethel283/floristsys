...
if(isset($_POST['update']))
{
	...
	$result=mysqli_query($db,"UPDATE users SET fname='$fname',lname='$lname',contact_no='$contact_no',username='$username',password='$password' WHERE id='$id'");

	echo "<script>alert('Update Successfully');window.location.href='user_profile.php'</script>";
}
?>
<?php
$id=$_SESSION['id'];
